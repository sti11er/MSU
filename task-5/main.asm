...
; процедура записи в память, текста, который мы приняли за комманду
...
; процедура проверки на ввод комманды завершения текста
CheckFinText proc
     ;пролог процедуры:
     push ebp
     mov ebp,esp   ; база стекового кадра
...
; процедура замены числа, представленного 
; в 16-ой форме на символ из аски таблицы под этим номером
Convert proc
     ;пролог процедуры:
     push ebp
     mov ebp,esp   ; база стекового кадра
...
; основная процедура сохранение, введенного из потока 
; ввода, текста
SaveText proc  
     ; пролог процедуры:
     push ebp
...
; процедура печати записанной в память информации
PrintText proc
     ; пролог процедуры:
     push ebp
     mov ebp,esp    ; база стекового кадра
...
; процедура получения метрики длины текста
GetTheLength proc 
     ; пролог процедуры:
     push ebp
     mov ebp,esp    ; база стекового кадра
...
; процедура обработки1 для меньшего, по длинне, текста
Convert1 proc 
     ; пролог процедуры:
     push ebp
     mov ebp,esp    ; база стекового кадра
...
; проверка на то, что перед нами буква
CheckLetter proc
     ; пролог процедуры:
     push ebp
     mov ebp,esp  ; база стекового кадра
...
; процедура обработки2 для большего, по длинне, текста
Convert2 proc 
     ; пролог процедуры:
     push ebp
     mov ebp,esp  ; база стекового кадра
